...
- [ ] 2.1 Supabase Free 플랜으로 `mangotalk-dev` 프로젝트를 만들고 익명 인증과 Flutter 접속 정보를 준비한다
...
- [ ] 5.5 위로 스크롤할 때 이전 메시지를 불러오고 기존 스크롤 위치를 유지한다
...
- [ ] 5.8 새 메시지 실시간 반영과 사용자의 현재 스크롤 위치를 고려한 자동 스크롤 동작을 구현한다
